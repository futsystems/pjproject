...
#export TEST_LDFLAGS += -L/Users/qianbo/worktable/pjsip/output/bcg729/lib -O2 -miphoneos-version-min=7.0 -arch  arm64 -isysroot /Applications/XCode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS11.3.sdk -framework AudioToolbox -framework Foundation -L/Users/qianbo/worktable/pjsip/src/OpenSSL-for-iPhone/lib -lbcg729 -lssl -lcrypto -lm -lpthread  -framework CoreAudio -framework CoreFoundation -framework AudioToolbox -framework CFNetwork -framework UIKit -framework UIKit -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia -framework VideoToolbox -framework OpenGLES
